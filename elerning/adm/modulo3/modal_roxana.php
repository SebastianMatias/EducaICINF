    <!-- MODAL -->
<div class="modal fade" id="myModal_terminos" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Terminos Pareados</h4>
        </div>
...
<!-- / MODAL -->
    ...
    <!-- MODAL -->
<div class="modal fade" id="myModal_crucigrama" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Crucigramas</h4>
        </div>
